...
namespace CompactOT.Primitives
{
    public class HashRandomOracleTests
    {
        ...
        public void TestInvokeForEnumerator()
        {
            ...
            innerQuery[innerQuery.Length - 4] = 0;
            innerQuery[innerQuery.Length - 3] = 0;
            innerQuery[innerQuery.Length - 2] = 0;
            innerQuery[innerQuery.Length - 1] = 0;
            ...
            innerQuery[innerQuery.Length - 4] = 1;
